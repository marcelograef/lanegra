...
except Exception as Elme:
    print("Ocurrió un error al cargar libromayorelnx ", Elme)
    conexion.commit()
...
except Exception as E_lme:
    print("Ocurrió un error al cargar libromayoreln ", E_lme)
...
except Exception as etable:
    print("Ocurrió un error al cargar IngresoyEgregso ", etable)    
